...
--
-- Name: discussion_status_t; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.discussion_status_t AS ENUM (
    'otvoreno',
    'zatvoreno'
);
...
--
-- Name: meeting_status_t; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.meeting_status_t AS ENUM (
    'skica',
    'zakazano',
    'otkazano',
    'održano'
...
--
-- Name: role_t; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: visibility_t; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: vote_choice_t; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.vote_choice_t AS ENUM (
    'da',
    'ne'
);
...
--
-- Name: require_discussion_owner(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.require_discussion_owner() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: require_message_author(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.require_message_author() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: require_poll_author(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.require_poll_author() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    IF NEW.author_id IS NULL THEN
...
CREATE TABLE public.app_user (
    ...
    role public.role_t DEFAULT 'suvlasnik'::public.role_t NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
...
--
-- Name: building_membership; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.building_membership (
    building_id uuid NOT NULL,
    user_id uuid NOT NULL,
    user_role public.role_t NOT NULL
);
...
CREATE TABLE public.discussion (
    ...
    poll_description character varying(255),
    building_id uuid NOT NULL,
    owner_id uuid,
    visibility public.visibility_t DEFAULT 'privatno'::public.visibility_t NOT NULL,
    status public.discussion_status_t DEFAULT 'otvoreno'::public.discussion_status_t NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);


--
-- Name: discussion_participant; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.vote (
    ...
    user_id uuid,
    value public.vote_choice_t NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
...
--
-- Name: FUNCTION require_discussion_owner(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.require_discussion_owner() TO anon;
GRANT ALL ON FUNCTION public.require_discussion_owner() TO authenticated;
GRANT ALL ON FUNCTION public.require_discussion_owner() TO service_role;


--
-- Name: FUNCTION require_message_author(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.require_message_author() TO anon;
GRANT ALL ON FUNCTION public.require_message_author() TO authenticated;
GRANT ALL ON FUNCTION public.require_message_author() TO service_role;


--
-- Name: FUNCTION require_poll_author(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.require_poll_author() TO anon;
GRANT ALL ON FUNCTION public.require_poll_author() TO authenticated;
GRANT ALL ON FUNCTION public.require_poll_author() TO service_role;
...
--
-- Name: TABLE building; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE building_membership; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.building_membership TO anon;
GRANT ALL ON TABLE public.building_membership TO authenticated;
GRANT ALL ON TABLE public.building_membership TO service_role;


--
-- Name: TABLE discussion; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE discussion_participant; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.discussion_participant TO anon;
GRANT ALL ON TABLE public.discussion_participant TO authenticated;
GRANT ALL ON TABLE public.discussion_participant TO service_role;
...
--
-- Name: TABLE poll; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE upload; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.upload TO anon;
GRANT ALL ON TABLE public.upload TO authenticated;
GRANT ALL ON TABLE public.upload TO service_role;
